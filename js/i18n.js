...
const FOMO_DEALS_BY_COUNTRY = {
  BR: [
    ...
    { route: 'GRU \u2192 Dubai (Emirates, direto, 14h25)', original: 'R$ 5.500', deal: 'R$ 2.400', savings: '56% OFF' },
    { route: 'GRU \u2192 Bangkok (Qatar, via Doha, 22h45)', original: 'R$ 6.800', deal: 'R$ 2.300', savings: '66% OFF' },
    { route: 'GRU \u2192 T\u00F3quio (ANA, via Houston, 24h)', original: 'R$ 8.200', deal: 'R$ 3.100', savings: '62% OFF' },
    { route: 'GIG \u2192 Roma (ITA Airways, direto, 11h)', original: 'R$ 4.900', deal: 'R$ 1.800', savings: '63% OFF' },
    { route: 'GRU \u2192 Cidade do M\u00E9xico (Aeromexico, direto, 10h)', original: 'R$ 3.500', deal: 'R$ 1.100', savings: '69% OFF' },
    { route: 'GRU \u2192 Nova York (LATAM, direto, 10h)', original: 'R$ 4.200', deal: 'R$ 1.400', savings: '67% OFF' },
    { route: 'GIG \u2192 Madri (Ib\u00E9ria, direto, 10h15)', original: 'R$ 4.600', deal: 'R$ 1.550', savings: '66% OFF' },
    { route: 'GRU \u2192 Londres (British Airways, direto, 11h45)', original: 'R$ 5.800', deal: 'R$ 2.200', savings: '62% OFF' },
    { route: 'GRU \u2192 Canc\u00FAn (Aeromexico, via MEX, 12h)', original: 'R$ 3.800', deal: 'R$ 1.300', savings: '66% OFF' },
    { route: 'CNF \u2192 Miami (American, via GRU, 14h)', original: 'R$ 4.100', deal: 'R$ 1.500', savings: '63% OFF' },
    { route: 'GRU \u2192 Seul (Korean Air, via ICN, 26h)', original: 'R$ 7.400', deal: 'R$ 2.800', savings: '62% OFF' },
    { route: 'GRU \u2192 Cairo (Emirates, via Dubai, 20h)', original: 'R$ 6.200', deal: 'R$ 2.500', savings: '60% OFF' },
    { route: 'GIG \u2192 Amsterdã (KLM, direto, 11h30)', original: 'R$ 5.100', deal: 'R$ 1.900', savings: '63% OFF' },
    { route: 'GRU \u2192 Santiago (LATAM, direto, 4h30)', original: 'R$ 2.800', deal: 'R$ 890', savings: '68% OFF' },
  ],
  US: [
    ...
    { route: 'MIA \u2192 London (British Airways, nonstop, 9h)', original: '$780', deal: '$245', savings: '69% OFF' },
    ...
    { route: 'JFK \u2192 Barcelona (Iberia, nonstop, 8h)', original: '$950', deal: '$310', savings: '67% OFF' },
    { route: 'LAX \u2192 Sydney (Qantas, nonstop, 15h)', original: '$1,800', deal: '$590', savings: '67% OFF' },
    { route: 'EWR \u2192 Dubai (Emirates, nonstop, 12h30)', original: '$1,050', deal: '$340', savings: '68% OFF' },
    { route: 'ATL \u2192 Amsterdam (Delta, nonstop, 9h)', original: '$920', deal: '$285', savings: '69% OFF' },
    { route: 'SFO \u2192 Bali (Cathay Pacific, via HKG, 20h)', original: '$2,400', deal: '$799', savings: '67% OFF' },
    { route: 'BOS \u2192 Reykjavik (Icelandair, nonstop, 5h)', original: '$650', deal: '$189', savings: '71% OFF' },
    { route: 'ORD \u2192 Bangkok (EVA Air, via Taipei, 19h)', original: '$1,200', deal: '$389', savings: '68% OFF' },
    { route: 'JFK \u2192 Cape Town (Delta, via JNB, 18h)', original: '$1,600', deal: '$520', savings: '68% OFF' },
    { route: 'LAX \u2192 Tahiti (Air Tahiti Nui, nonstop, 8h)', original: '$1,400', deal: '$450', savings: '68% OFF' },
    { route: 'MIA \u2192 S\u00E3o Paulo (LATAM, nonstop, 8h30)', original: '$890', deal: '$280', savings: '69% OFF' },
  ],
  GB: [
    { route: 'LHR \u2192 Tokyo (JAL, via Helsinki, 14h)', original: '\u00A31,200', deal: '\u00A3380', savings: '68% OFF' },
    { route: 'LHR \u2192 New York (BA, nonstop, 8h)', original: '\u00A3650', deal: '\u00A3189', savings: '71% OFF' },
    { route: 'LGW \u2192 Bali (Singapore Air, via SIN, 16h)', original: '\u00A3900', deal: '\u00A3320', savings: '64% OFF' },
    { route: 'MAN \u2192 Dubai (Emirates, nonstop, 7h)', original: '\u00A3580', deal: '\u00A3195', savings: '66% OFF' },
    { route: 'LHR \u2192 Bangkok (Thai Airways, nonstop, 11h30)', original: '\u00A3750', deal: '\u00A3260', savings: '65% OFF' },
    { route: 'EDI \u2192 Reykjavik (Icelandair, nonstop, 3h)', original: '\u00A3350', deal: '\u00A398', savings: '72% OFF' },
    { route: 'LHR \u2192 Cape Town (BA, nonstop, 11h30)', original: '\u00A3980', deal: '\u00A3340', savings: '65% OFF' },
    { route: 'LGW \u2192 Canc\u00FAn (BA, nonstop, 10h)', original: '\u00A3720', deal: '\u00A3249', savings: '65% OFF' },
    { route: 'MAN \u2192 S\u00E3o Paulo (Virgin, via LHR, 13h)', original: '\u00A31,100', deal: '\u00A3380', savings: '65% OFF' },
    { route: 'LHR \u2192 Seoul (Korean Air, nonstop, 11h)', original: '\u00A3850', deal: '\u00A3290', savings: '66% OFF' },
    { route: 'STN \u2192 Marrakech (Ryanair, nonstop, 3h30)', original: '\u00A3280', deal: '\u00A369', savings: '75% OFF' },
    { route: 'LHR \u2192 Sydney (Qantas, via Singapore, 22h)', original: '\u00A31,500', deal: '\u00A3520', savings: '65% OFF' },
  ],
  EU: [
    { route: 'CDG \u2192 Tokyo (Air France, nonstop, 12h)', original: '\u20AC1,100', deal: '\u20AC390', savings: '65% OFF' },
    { route: 'FRA \u2192 Bangkok (Lufthansa, nonstop, 10h45)', original: '\u20AC850', deal: '\u20AC289', savings: '66% OFF' },
    { route: 'AMS \u2192 Bali (KLM, via Singapore, 17h)', original: '\u20AC950', deal: '\u20AC340', savings: '64% OFF' },
    { route: 'BCN \u2192 New York (TAP, via Lisbon, 11h)', original: '\u20AC680', deal: '\u20AC210', savings: '69% OFF' },
    { route: 'FCO \u2192 Rio (ITA Airways, nonstop, 11h)', original: '\u20AC890', deal: '\u20AC310', savings: '65% OFF' },
    { route: 'MAD \u2192 Dubai (Emirates, nonstop, 7h)', original: '\u20AC650', deal: '\u20AC210', savings: '68% OFF' },
    { route: 'MUC \u2192 Cape Town (Lufthansa, via JNB, 14h)', original: '\u20AC1,050', deal: '\u20AC370', savings: '65% OFF' },
    { route: 'CDG \u2192 Seoul (Korean Air, nonstop, 11h)', original: '\u20AC980', deal: '\u20AC330', savings: '66% OFF' },
    { route: 'LIS \u2192 Canc\u00FAn (TAP, nonstop, 10h)', original: '\u20AC750', deal: '\u20AC240', savings: '68% OFF' },
    { route: 'AMS \u2192 Buenos Aires (KLM, nonstop, 13h)', original: '\u20AC920', deal: '\u20AC310', savings: '66% OFF' },
    { route: 'FRA \u2192 Maldivas (Condor, nonstop, 10h)', original: '\u20AC1,200', deal: '\u20AC420', savings: '65% OFF' },
    { route: 'VIE \u2192 Sydney (Austrian, via BKK, 20h)', original: '\u20AC1,400', deal: '\u20AC490', savings: '65% OFF' },
  ],
  AU: [
...
const DEST_DEALS_BY_COUNTRY = {
  BR: [
    { img: IMGS.paris, route: 'GRU \u2192 Paris', sub: 'Air France \u2022 Direto \u2022 11h30', original: 'R$ 5.200', deal: 'R$ 2.100', tag: 'ERROR FARE' },
    { img: IMGS.dubai, route: 'GRU \u2192 Dubai', sub: 'Emirates \u2022 Direto \u2022 14h25', original: 'R$ 5.500', deal: 'R$ 2.400', tag: 'BUG' },
    { img: IMGS.bali, route: 'GRU \u2192 Bali', sub: 'Qatar Airways \u2022 Via Doha \u2022 26h', original: 'R$ 7.500', deal: 'R$ 3.999', tag: 'ERROR FARE' },
    { img: IMGS.miami, route: 'GRU \u2192 Miami', sub: 'LATAM \u2022 Direto \u2022 8h30', original: 'R$ 3.200', deal: 'R$ 1.200', tag: 'PROMO' },
    { img: IMGS.roma, route: 'GRU \u2192 Roma', sub: 'ITA Airways \u2022 Direto \u2022 11h', original: 'R$ 4.900', deal: 'R$ 1.650', tag: 'ERROR FARE' },
    { img: IMGS.bangkok, route: 'GRU \u2192 Bangkok', sub: 'Emirates \u2022 Via Dubai \u2022 22h', original: 'R$ 6.800', deal: 'R$ 2.300', tag: 'BUG' },
    { img: IMGS.tokyo, route: 'GRU \u2192 T\u00F3quio', sub: 'ANA \u2022 Via Houston \u2022 24h', original: 'R$ 8.200', deal: 'R$ 3.100', tag: 'MISTAKE' },
    { img: IMGS.london, route: 'GRU \u2192 Londres', sub: 'British Airways \u2022 Direto \u2022 11h45', original: 'R$ 5.800', deal: 'R$ 2.200', tag: 'ERROR FARE' },
    { img: IMGS.nyc, route: 'GRU \u2192 Nova York', sub: 'LATAM \u2022 Direto \u2022 10h', original: 'R$ 4.200', deal: 'R$ 1.400', tag: 'GLITCH' },
    { img: IMGS.cancun, route: 'GRU \u2192 Canc\u00FAn', sub: 'Aeromexico \u2022 Via MEX \u2022 12h', original: 'R$ 3.800', deal: 'R$ 1.300', tag: 'BUG' },
    { img: IMGS.maldivas, route: 'GRU \u2192 Maldivas', sub: 'Emirates \u2022 Via Dubai \u2022 22h', original: 'R$ 9.200', deal: 'R$ 3.500', tag: 'ERROR FARE' },
    { img: IMGS.seoul, route: 'GRU \u2192 Seul', sub: 'Korean Air \u2022 Via ICN \u2022 26h', original: 'R$ 7.400', deal: 'R$ 2.800', tag: 'MISTAKE' },
    { img: IMGS.capetown, route: 'GRU \u2192 Cape Town', sub: 'LATAM \u2022 Via GRU/JNB \u2022 16h', original: 'R$ 6.500', deal: 'R$ 2.400', tag: 'DEAL' },
    { img: IMGS.sydney, route: 'GRU \u2192 Sydney', sub: 'Qantas \u2022 Via Santiago \u2022 20h', original: 'R$ 8.800', deal: 'R$ 3.200', tag: 'ERROR FARE' },
  ],
  US: [
    { img: IMGS.paris, route: 'JFK \u2192 Paris', sub: 'Air France \u2022 Nonstop \u2022 7h20', original: '$890', deal: '$289', tag: 'ERROR FARE' },
    { img: IMGS.tokyo, route: 'LAX \u2192 Tokyo', sub: 'ANA \u2022 Nonstop \u2022 11h30', original: '$1,400', deal: '$489', tag: 'MISTAKE' },
    { img: IMGS.bali, route: 'SFO \u2192 Bali', sub: 'Cathay Pacific \u2022 Via HKG \u2022 20h', original: '$2,400', deal: '$799', tag: 'ERROR FARE' },
    { img: IMGS.roma, route: 'ORD \u2192 Rome', sub: 'ITA Airways \u2022 Nonstop \u2022 9h45', original: '$1,100', deal: '$310', tag: 'ERROR FARE' },
    { img: IMGS.dubai, route: 'JFK \u2192 Dubai', sub: 'Emirates \u2022 Nonstop \u2022 12h30', original: '$1,050', deal: '$340', tag: 'MISTAKE' },
    { img: IMGS.bangkok, route: 'LAX \u2192 Bangkok', sub: 'EVA Air \u2022 Via Taipei \u2022 19h', original: '$1,200', deal: '$389', tag: 'ERROR FARE' },
    { img: IMGS.london, route: 'JFK \u2192 London', sub: 'BA \u2022 Nonstop \u2022 7h', original: '$780', deal: '$245', tag: 'BUG' },
    { img: IMGS.cancun, route: 'DFW \u2192 Canc\u00FAn', sub: 'American \u2022 Nonstop \u2022 3h15', original: '$520', deal: '$129', tag: 'GLITCH' },
    { img: IMGS.sydney, route: 'LAX \u2192 Sydney', sub: 'Qantas \u2022 Nonstop \u2022 15h', original: '$1,800', deal: '$590', tag: 'ERROR FARE' },
    { img: IMGS.maldivas, route: 'JFK \u2192 Maldives', sub: 'Emirates \u2022 Via DXB \u2022 18h', original: '$2,200', deal: '$720', tag: 'BUG' },
    { img: IMGS.seoul, route: 'SFO \u2192 Seoul', sub: 'Korean Air \u2022 Nonstop \u2022 12h', original: '$1,300', deal: '$410', tag: 'MISTAKE' },
    { img: IMGS.iceland, route: 'BOS \u2192 Reykjavik', sub: 'Icelandair \u2022 Nonstop \u2022 5h', original: '$650', deal: '$189', tag: 'DEAL' },
    { img: IMGS.capetown, route: 'JFK \u2192 Cape Town', sub: 'Delta \u2022 Via JNB \u2022 18h', original: '$1,600', deal: '$520', tag: 'ERROR FARE' },
    { img: IMGS.marrakech, route: 'JFK \u2192 Marrakech', sub: 'Royal Air Maroc \u2022 Nonstop \u2022 7h', original: '$950', deal: '$310', tag: 'PROMO' },
  ],
  GB: [
    { img: IMGS.tokyo, route: 'LHR \u2192 Tokyo', sub: 'JAL \u2022 Via Helsinki \u2022 14h', original: '\u00A31,200', deal: '\u00A3380', tag: 'ERROR FARE' },
    { img: IMGS.nyc, route: 'LHR \u2192 New York', sub: 'BA \u2022 Nonstop \u2022 8h', original: '\u00A3650', deal: '\u00A3189', tag: 'MISTAKE' },
    { img: IMGS.bali, route: 'LGW \u2192 Bali', sub: 'Singapore Air \u2022 Via SIN \u2022 16h', original: '\u00A3900', deal: '\u00A3320', tag: 'ERROR FARE' },
    { img: IMGS.dubai, route: 'MAN \u2192 Dubai', sub: 'Emirates \u2022 Nonstop \u2022 7h', original: '\u00A3580', deal: '\u00A3195', tag: 'DEAL' },
    { img: IMGS.bangkok, route: 'LHR \u2192 Bangkok', sub: 'Thai Airways \u2022 Nonstop \u2022 11h30', original: '\u00A3750', deal: '\u00A3260', tag: 'ERROR FARE' },
    { img: IMGS.paris, route: 'LHR \u2192 Paris', sub: 'Eurostar \u2022 Train \u2022 2h15', original: '\u00A3200', deal: '\u00A359', tag: 'PROMO' },
    { img: IMGS.capetown, route: 'LHR \u2192 Cape Town', sub: 'BA \u2022 Nonstop \u2022 11h30', original: '\u00A3980', deal: '\u00A3340', tag: 'BUG' },
    { img: IMGS.cancun, route: 'LGW \u2192 Canc\u00FAn', sub: 'BA \u2022 Nonstop \u2022 10h', original: '\u00A3720', deal: '\u00A3249', tag: 'GLITCH' },
    { img: IMGS.seoul, route: 'LHR \u2192 Seoul', sub: 'Korean Air \u2022 Nonstop \u2022 11h', original: '\u00A3850', deal: '\u00A3290', tag: 'ERROR FARE' },
    { img: IMGS.iceland, route: 'EDI \u2192 Reykjavik', sub: 'Icelandair \u2022 Nonstop \u2022 3h', original: '\u00A3350', deal: '\u00A398', tag: 'DEAL' },
    { img: IMGS.maldivas, route: 'LHR \u2192 Maldives', sub: 'BA \u2022 Via Doha \u2022 14h', original: '\u00A31,400', deal: '\u00A3480', tag: 'ERROR FARE' },
    { img: IMGS.sydney, route: 'LHR \u2192 Sydney', sub: 'Qantas \u2022 Via Singapore \u2022 22h', original: '\u00A31,500', deal: '\u00A3520', tag: 'MISTAKE' },
    { img: IMGS.marrakech, route: 'STN \u2192 Marrakech', sub: 'Ryanair \u2022 Nonstop \u2022 3h30', original: '\u00A3280', deal: '\u00A369', tag: 'PROMO' },
  ],
  EU: [
    { img: IMGS.tokyo, route: 'CDG \u2192 Tokyo', sub: 'Air France \u2022 Nonstop \u2022 12h', original: '\u20AC1,100', deal: '\u20AC390', tag: 'ERROR FARE' },
    { img: IMGS.nyc, route: 'FRA \u2192 New York', sub: 'Lufthansa \u2022 Nonstop \u2022 9h', original: '\u20AC780', deal: '\u20AC249', tag: 'MISTAKE' },
    { img: IMGS.bali, route: 'AMS \u2192 Bali', sub: 'KLM \u2022 Via Singapore \u2022 17h', original: '\u20AC950', deal: '\u20AC340', tag: 'ERROR FARE' },
    { img: IMGS.dubai, route: 'MAD \u2192 Dubai', sub: 'Emirates \u2022 Nonstop \u2022 7h', original: '\u20AC650', deal: '\u20AC210', tag: 'DEAL' },
    { img: IMGS.bangkok, route: 'FRA \u2192 Bangkok', sub: 'Lufthansa \u2022 Nonstop \u2022 10h45', original: '\u20AC850', deal: '\u20AC289', tag: 'ERROR FARE' },
    { img: IMGS.roma, route: 'FCO \u2192 Rio', sub: 'ITA Airways \u2022 Nonstop \u2022 11h', original: '\u20AC890', deal: '\u20AC310', tag: 'MISTAKE' },
    { img: IMGS.seoul, route: 'CDG \u2192 Seoul', sub: 'Korean Air \u2022 Nonstop \u2022 11h', original: '\u20AC980', deal: '\u20AC330', tag: 'BUG' },
    { img: IMGS.cancun, route: 'LIS \u2192 Canc\u00FAn', sub: 'TAP \u2022 Nonstop \u2022 10h', original: '\u20AC750', deal: '\u20AC240', tag: 'GLITCH' },
    { img: IMGS.maldivas, route: 'FRA \u2192 Maldives', sub: 'Condor \u2022 Nonstop \u2022 10h', original: '\u20AC1,200', deal: '\u20AC420', tag: 'ERROR FARE' },
    { img: IMGS.capetown, route: 'MUC \u2192 Cape Town', sub: 'Lufthansa \u2022 Via JNB \u2022 14h', original: '\u20AC1,050', deal: '\u20AC370', tag: 'DEAL' },
    { img: IMGS.sydney, route: 'VIE \u2192 Sydney', sub: 'Austrian \u2022 Via BKK \u2022 20h', original: '\u20AC1,400', deal: '\u20AC490', tag: 'ERROR FARE' },
    { img: IMGS.london, route: 'BCN \u2192 London', sub: 'Vueling \u2022 Nonstop \u2022 2h30', original: '\u20AC250', deal: '\u20AC59', tag: 'PROMO' },
    { img: IMGS.marrakech, route: 'MAD \u2192 Marrakech', sub: 'Ryanair \u2022 Nonstop \u2022 2h', original: '\u20AC280', deal: '\u20AC49', tag: 'DEAL' },
  ],
  AU: [
